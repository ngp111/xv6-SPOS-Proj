...
int main(int argc,char *argv[])
{
  ...
  38:	ff 33                	pushl  (%ebx)
  3a:	e8 e3 02 00 00       	call   322 <open>
  ...
  4c:	83 c3 04             	add    $0x4,%ebx
        close(err);
  4f:	50                   	push   %eax
  50:	e8 b5 02 00 00       	call   30a <close>
    for(i=1;i<argc;i++)
  ...
  61:	50                   	push   %eax
  62:	ff 33                	pushl  (%ebx)
  64:	68 b4 07 00 00       	push   $0x7b4
  69:	6a 01                	push   $0x1
  6b:	e8 d0 03 00 00       	call   440 <printf>
            exit();
  70:	e8 6d 02 00 00       	call   2e2 <exit>
        printf(1,"Usage: touch [files]...\n");
  75:	52                   	push   %edx
  76:	52                   	push   %edx
  77:	68 98 07 00 00       	push   $0x798
  7c:	6a 01                	push   $0x1
  7e:	e8 bd 03 00 00       	call   440 <printf>
        exit();
  83:	e8 5a 02 00 00       	call   2e2 <exit>
  88:	66 90                	xchg   %ax,%ax
  8a:	66 90                	xchg   %ax,%ax
  8c:	66 90                	xchg   %ax,%ax
  8e:	66 90                	xchg   %ax,%ax
...
free(void *ap)
{
 ...
 611:	a1 8c 0a 00 00       	mov    0xa8c,%eax
{
 ...
 64d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 64f:	a3 8c 0a 00 00       	mov    %eax,0xa8c
}
 654:	5b                   	pop    %ebx
 655:	5e                   	pop    %esi
 656:	5f                   	pop    %edi
 ...
 666:	72 ce                	jb     636 <free+0x26>
{
 ...
 687:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 68a:	a3 8c 0a 00 00       	mov    %eax,0xa8c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6a9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6ac:	8b 15 8c 0a 00 00    	mov    0xa8c,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6ef:	73 47                	jae    738 <malloc+0x98>
    ...
    if(p == freep)
 6f1:	39 05 8c 0a 00 00    	cmp    %eax,0xa8c
 ...
 716:	e8 f5 fe ff ff       	call   610 <free>
  return freep;
 71b:	8b 15 8c 0a 00 00    	mov    0xa8c,%edx
 ...
 744:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 747:	89 15 8c 0a 00 00    	mov    %edx,0xa8c
}
 ...
 759:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 760:	c7 05 8c 0a 00 00 90 	movl   $0xa90,0xa8c
 767:	0a 00 00 
 76a:	c7 05 90 0a 00 00 90 	movl   $0xa90,0xa90
 771:	0a 00 00 
    base.s.size = 0;
 774:	b8 90 0a 00 00       	mov    $0xa90,%eax
