  ...
  11:	83 39 01             	cmpl   $0x1,(%ecx)
{
  ...
  1f:	e8 de 02 00 00       	call   302 <chdir>
  24:	83 c4 10             	add    $0x10,%esp
  27:	85 c0                	test   %eax,%eax
  29:	75 08                	jne    33 <main+0x33>
    {
        exit(0);
    }
}
  ...
  36:	6a 00                	push   $0x0
  38:	e8 55 02 00 00       	call   292 <exit>
  3d:	66 90                	xchg   %ax,%ax
  3f:	90                   	nop
 ...
 5c1:	a1 00 0a 00 00       	mov    0xa00,%eax
{
 ...
 5fd:	89 08                	mov    %ecx,(%eax)
  freep = p;
 5ff:	a3 00 0a 00 00       	mov    %eax,0xa00
}
 604:	5b                   	pop    %ebx
 605:	5e                   	pop    %esi
 606:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 659:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 65c:	8b 15 00 0a 00 00    	mov    0xa00,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 69f:	73 47                	jae    6e8 <malloc+0x98>
    ...
    if(p == freep)
 6a1:	39 05 00 0a 00 00    	cmp    %eax,0xa00
 ...
 6c6:	e8 f5 fe ff ff       	call   5c0 <free>
  return freep;
 6cb:	8b 15 00 0a 00 00    	mov    0xa00,%edx
 ...
 6f4:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 6f7:	89 15 00 0a 00 00    	mov    %edx,0xa00
}
 ...
 709:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 710:	c7 05 00 0a 00 00 04 	movl   $0xa04,0xa00
 717:	0a 00 00 
 71a:	c7 05 04 0a 00 00 04 	movl   $0xa04,0xa04
 721:	0a 00 00 
    base.s.size = 0;
 724:	b8 04 0a 00 00       	mov    $0xa04,%eax
 729:	c7 05 08 0a 00 00 00 	movl   $0x0,0xa08
 730:	00 00 00 
