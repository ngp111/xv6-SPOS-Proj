...
printf(int fd, const char *fmt, ...)
{
 ...
 634:	e9 8f fe ff ff       	jmp    4c8 <printf+0x48>
          s = "(null)";
 639:	bb ff 07 00 00       	mov    $0x7ff,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 651:	a1 c0 0a 00 00       	mov    0xac0,%eax
{
 ...
 68d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 68f:	a3 c0 0a 00 00       	mov    %eax,0xac0
}
 694:	5b                   	pop    %ebx
 695:	5e                   	pop    %esi
 696:	5f                   	pop    %edi
 ...
 6a6:	72 ce                	jb     676 <free+0x26>
{
 ...
 6c7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 6ca:	a3 c0 0a 00 00       	mov    %eax,0xac0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6e9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6ec:	8b 15 c0 0a 00 00    	mov    0xac0,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 72f:	73 47                	jae    778 <malloc+0x98>
    ...
    if(p == freep)
 731:	39 05 c0 0a 00 00    	cmp    %eax,0xac0
 ...
 756:	e8 f5 fe ff ff       	call   650 <free>
  return freep;
 75b:	8b 15 c0 0a 00 00    	mov    0xac0,%edx
 ...
 784:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 787:	89 15 c0 0a 00 00    	mov    %edx,0xac0
}
 ...
 7a7:	0a 00 00 
 7aa:	c7 05 c4 0a 00 00 c4 	movl   $0xac4,0xac4
 7b1:	0a 00 00 
    base.s.size = 0;
 7b4:	b8 c4 0a 00 00       	mov    $0xac4,%eax
 7b9:	c7 05 c8 0a 00 00 00 	movl   $0x0,0xac8
 7c0:	00 00 00 
